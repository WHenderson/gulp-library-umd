...
suite('basic', () ->
  ...
  suite('templates', () ->
    ...
    for template in ['amd', 'amdWeb', 'amdCommonWeb', 'amdWebGlobal', 'common', 'commonjsAdapter', 'commonjsStrict', 'commonjsStrictGlobal', 'jqueryPlugin', 'nodeAdapter', 'returnExports', 'returnExportsGlobal']
      do (template) ->
        suite(template, () ->
