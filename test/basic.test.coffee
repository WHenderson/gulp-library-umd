...
suite('basic', () ->
  ...
  suite('templates', () ->
    ...
    for template in ['amd', 'amdWeb', 'amdWebGlobal', 'commonjsAdapter', 'commonjsStrict', 'commonjsStrictGlobal', 'jqueryPlugin', 'nodeAdapter', 'returnExports', 'returnExportsGlobal']
      do (template) ->
        suite(template, () ->
